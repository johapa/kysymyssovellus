...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.kaynnista(A.lisaaKysymyksia());
    },
    kaynnista(kysymyslista) {
      var t2, nappiAlusta,
        _s10_ = "#nappiUusi",
        _s12_ = "#nappiAlusta",
        t1 = document,
        nappi = t1.querySelector(_s10_);
      nappi.toString;
      t2 = J.getInterceptor$x(nappi);
      t2.replaceWith$1(nappi, t2.clone$1(nappi, true));
      t1.querySelector(_s10_);
      nappiAlusta = t1.querySelector(_s12_);
      nappiAlusta.toString;
      t2 = J.getInterceptor$x(nappiAlusta);
      t2.replaceWith$1(nappiAlusta, t2.clone$1(nappiAlusta, true));
      t1.querySelector(_s12_);
      nappi = t1.querySelector(_s10_);
      nappi.toString;
      t1 = J.get$onClick$x(nappi);
      t2 = t1.$ti;
      A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.kaynnista_closure(kysymyslista)), false, t2._precomputed1);
    },
    asetaVaihtoehdot(kysymyslista) {
      var vaihtoehdot, t2, i, elementti,
        _s11_ = "vaihtoehdot",
        _s8_ = "#vastaus",
        t1 = $.indeksi;
      if (!(t1 < kysymyslista.length))
        return A.ioore(kysymyslista, t1);
      vaihtoehdot = kysymyslista[t1].$index(0, _s11_);
      t1 = document;
      ...
      for (i = 0; i < vaihtoehdot.length; ++i) {
        ...
        elementti.className = _s11_;
        if (!(i < vaihtoehdot.length))
          return A.ioore(vaihtoehdot, i);
        B.DivElement_methods.set$text(elementti, A._asStringQ(vaihtoehdot[i]));
        t2 = t1.querySelector(_s8_);
        t2.toString;
        J.get$children$x(t2).add$1(0, elementti);
      }
    },
    vastaaKysymykseen(kysymyslista) {
      var oikein, t2, vaihtoehdot, t3, t4, t5, _box_0 = {},
        t1 = $.indeksi;
      if (!(t1 < kysymyslista.length))
        return A.ioore(kysymyslista, t1);
      oikein = kysymyslista[t1].$index(0, "oikein");
      t1 = type$.Element;
      t2 = document;
      t2.toString;
      A.checkTypeBound(t1, t1, "T", "querySelectorAll");
      t2 = t2.querySelectorAll(".vaihtoehdot");
      t2.toString;
      t1 = type$._FrozenElementList_Element;
      vaihtoehdot = new A._FrozenElementList(t2, t1);
      _box_0.vastattu = false;
      for (t2 = new A.ListIterator(vaihtoehdot, vaihtoehdot.get$length(0), t1._eval$1("ListIterator<ListBase.E>")), t1 = t1._eval$1("ListBase.E"); t2.moveNext$0();) {
        t3 = t2.__internal$_current;
        if (t3 == null)
          t3 = t1._as(t3);
        t4 = J.get$onClick$x(t3);
        t5 = t4.$ti;
        A._EventStreamSubscription$(t4._target, t4._eventType, t5._eval$1("~(1)?")._as(new A.vastaaKysymykseen_closure(_box_0, kysymyslista, oikein, t3)), false, t5._precomputed1);
      }
    },
    lopeta(kysymyslista) {
      var t2, nappi, nappiAlusta, t3, t1 = {};
      t1.kysymyslista = kysymyslista;
      t2 = document;
      nappi = t2.querySelector("#nappiUusi");
      nappiAlusta = t2.querySelector("#nappiAlusta");
      nappi.toString;
      t2 = J.get$onClick$x(nappi);
      t3 = t2.$ti;
      A._EventStreamSubscription$(t2._target, t2._eventType, t3._eval$1("~(1)?")._as(new A.lopeta_closure(nappi, nappiAlusta)), false, t3._precomputed1);
      nappiAlusta.toString;
      t3 = J.get$onClick$x(nappiAlusta);
      t2 = t3.$ti;
      A._EventStreamSubscription$(t3._target, t3._eventType, t2._eval$1("~(1)?")._as(new A.lopeta_closure0(t1, nappi, nappiAlusta)), false, t2._precomputed1);
    },
    lisaaKysymyksia() {
      var t2, kysymysToka, kysymysKolmas, kysymysNelkku, kysymysViitonen, kysymysKuutonen, kysymysSeiska, kysymysKasi, kysymysYsi, kysymysKymppi, kysymysYkstoista, kysymysKakstoista, kysymysKolmetoista, kysymysNeljatoista, kysymysViisitoista, kysymysKuustoista, kysymysSeittemantoista, kysymysKahdekstoista, kysymysYheksantoista, kysymysKakskyt,
        _s7_ = "kysymys",
        _s11_ = "vaihtoehdot",
        _s6_ = "oikein", kysymyslista = [],
        t1 = type$.dynamic,
        kysymysEka = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysEka.$indexSet(0, _s7_, 'Mik\xe4 on "auto" englanniksi?');
      t2 = type$.JSArray_String;
      kysymysEka.$indexSet(0, _s11_, A._setArrayType(["car", "boat", "plane"], t2));
      kysymysEka.$indexSet(0, _s6_, "car");
      kysymyslista.push(kysymysEka);
      kysymysToka = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysToka.$indexSet(0, _s7_, 'Mik\xe4 on "omena" englanniksi?');
      kysymysToka.$indexSet(0, _s11_, A._setArrayType(["kiwi", "apple", "orange"], t2));
      kysymysToka.$indexSet(0, _s6_, "apple");
      kysymyslista.push(kysymysToka);
      kysymysKolmas = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKolmas.$indexSet(0, _s7_, 'Mik\xe4 on "tietokone" englanniksi?');
      kysymysKolmas.$indexSet(0, _s11_, A._setArrayType(["machine", "widget", "computer"], t2));
      kysymysKolmas.$indexSet(0, _s6_, "computer");
      kysymyslista.push(kysymysKolmas);
      kysymysNelkku = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysNelkku.$indexSet(0, _s7_, 'Mik\xe4 on "kirja" englanniksi?');
      kysymysNelkku.$indexSet(0, _s11_, A._setArrayType(["book", "magazine", "newspaper"], t2));
      kysymysNelkku.$indexSet(0, _s6_, "book");
      kysymyslista.push(kysymysNelkku);
      kysymysViitonen = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysViitonen.$indexSet(0, _s7_, 'Mik\xe4 on "talo" englanniksi?');
      kysymysViitonen.$indexSet(0, _s11_, A._setArrayType(["apartment", "house", "tent"], t2));
      kysymysViitonen.$indexSet(0, _s6_, "house");
      kysymyslista.push(kysymysViitonen);
      kysymysKuutonen = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKuutonen.$indexSet(0, _s7_, 'Mik\xe4 on "p\xf6yt\xe4" englanniksi?');
      kysymysKuutonen.$indexSet(0, _s11_, A._setArrayType(["chair", "table", "bed"], t2));
      kysymysKuutonen.$indexSet(0, _s6_, "table");
      kysymyslista.push(kysymysKuutonen);
      kysymysSeiska = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysSeiska.$indexSet(0, _s7_, 'Mik\xe4 on "puu" englanniksi?');
      kysymysSeiska.$indexSet(0, _s11_, A._setArrayType(["bush", "tree", "flower"], t2));
      kysymysSeiska.$indexSet(0, _s6_, "tree");
      kysymyslista.push(kysymysSeiska);
      kysymysKasi = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKasi.$indexSet(0, _s7_, 'Mik\xe4 on "koira" englanniksi?');
      kysymysKasi.$indexSet(0, _s11_, A._setArrayType(["cat", "dog", "rabbit"], t2));
      kysymysKasi.$indexSet(0, _s6_, "dog");
      kysymyslista.push(kysymysKasi);
      kysymysYsi = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysYsi.$indexSet(0, _s7_, 'Mik\xe4 on "kissa" englanniksi?');
      kysymysYsi.$indexSet(0, _s11_, A._setArrayType(["cat", "dog", "mouse"], t2));
      kysymysYsi.$indexSet(0, _s6_, "cat");
      kysymyslista.push(kysymysYsi);
      kysymysKymppi = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKymppi.$indexSet(0, _s7_, 'Mik\xe4 on "aurinko" englanniksi?');
      kysymysKymppi.$indexSet(0, _s11_, A._setArrayType(["moon", "sun", "star"], t2));
      kysymysKymppi.$indexSet(0, _s6_, "sun");
      kysymyslista.push(kysymysKymppi);
      kysymysYkstoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysYkstoista.$indexSet(0, _s7_, 'Mik\xe4 on "kuu" englanniksi?');
      kysymysYkstoista.$indexSet(0, _s11_, A._setArrayType(["sun", "moon", "star"], t2));
      kysymysYkstoista.$indexSet(0, _s6_, "moon");
      kysymyslista.push(kysymysYkstoista);
      kysymysKakstoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKakstoista.$indexSet(0, _s7_, 'Mik\xe4 on "t\xe4hti" englanniksi?');
      kysymysKakstoista.$indexSet(0, _s11_, A._setArrayType(["star", "sun", "planet"], t2));
      kysymysKakstoista.$indexSet(0, _s6_, "star");
      kysymyslista.push(kysymysKakstoista);
      kysymysKolmetoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKolmetoista.$indexSet(0, _s7_, 'Mik\xe4 on "vesi" englanniksi?');
      kysymysKolmetoista.$indexSet(0, _s11_, A._setArrayType(["water", "juice", "milk"], t2));
      kysymysKolmetoista.$indexSet(0, _s6_, "water");
      kysymyslista.push(kysymysKolmetoista);
      kysymysNeljatoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysNeljatoista.$indexSet(0, _s7_, 'Mik\xe4 on "maito" englanniksi?');
      kysymysNeljatoista.$indexSet(0, _s11_, A._setArrayType(["water", "milk", "juice"], t2));
      kysymysNeljatoista.$indexSet(0, _s6_, "milk");
      kysymyslista.push(kysymysNeljatoista);
      kysymysViisitoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysViisitoista.$indexSet(0, _s7_, 'Mik\xe4 on "mehu" englanniksi?');
      kysymysViisitoista.$indexSet(0, _s11_, A._setArrayType(["water", "juice", "soda"], t2));
      kysymysViisitoista.$indexSet(0, _s6_, "juice");
      kysymyslista.push(kysymysViisitoista);
      kysymysKuustoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKuustoista.$indexSet(0, _s7_, 'Mik\xe4 on "leip\xe4" englanniksi?');
      kysymysKuustoista.$indexSet(0, _s11_, A._setArrayType(["bread", "butter", "cheese"], t2));
      kysymysKuustoista.$indexSet(0, _s6_, "bread");
      kysymyslista.push(kysymysKuustoista);
      kysymysSeittemantoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysSeittemantoista.$indexSet(0, _s7_, 'Mik\xe4 on "voi" englanniksi?');
      kysymysSeittemantoista.$indexSet(0, _s11_, A._setArrayType(["bread", "butter", "cheese"], t2));
      kysymysSeittemantoista.$indexSet(0, _s6_, "butter");
      kysymyslista.push(kysymysSeittemantoista);
      kysymysKahdekstoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKahdekstoista.$indexSet(0, _s7_, 'Mik\xe4 on "juusto" englanniksi?');
      kysymysKahdekstoista.$indexSet(0, _s11_, A._setArrayType(["bread", "butter", "cheese"], t2));
      kysymysKahdekstoista.$indexSet(0, _s6_, "cheese");
      kysymyslista.push(kysymysKahdekstoista);
      kysymysYheksantoista = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysYheksantoista.$indexSet(0, _s7_, 'Mik\xe4 on "mies" englanniksi?');
      kysymysYheksantoista.$indexSet(0, _s11_, A._setArrayType(["man", "woman", "child"], t2));
      kysymysYheksantoista.$indexSet(0, _s6_, "man");
      kysymyslista.push(kysymysYheksantoista);
      kysymysKakskyt = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      kysymysKakskyt.$indexSet(0, _s7_, 'Mik\xe4 on "nainen" englanniksi?');
      kysymysKakskyt.$indexSet(0, _s11_, A._setArrayType(["man", "woman", "child"], t2));
      kysymysKakskyt.$indexSet(0, _s6_, "woman");
      kysymyslista.push(kysymysKakskyt);
      return kysymyslista;
    },
    kaynnista_closure: function kaynnista_closure(t0) {
      this.kysymyslista = t0;
    },
    vastaaKysymykseen_closure: function vastaaKysymykseen_closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.kysymyslista = t1;
      _.oikein = t2;
    ...
    lopeta_closure: function lopeta_closure(t0, t1) {
      this.nappi = t0;
      this.nappiAlusta = t1;
    },
    lopeta_closure0: function lopeta_closure0(t0, t1, t2) {
      this._box_0 = t0;
      this.nappi = t1;
      this.nappiAlusta = t2;
    },
  ...
  A.kaynnista_closure.prototype = {
    call$1(e) {
      var t1, t2, kysymys;
      type$.MouseEvent._as(e);
      t1 = this.kysymyslista;
      t2 = $.indeksi;
      if (!(t2 < t1.length))
        return A.ioore(t1, t2);
      kysymys = t1[t2];
      t2 = document.querySelector("#kysymys");
      t2.toString;
      J.set$text$x(t2, A._asStringQ(kysymys.$index(0, "kysymys")));
      A.asetaVaihtoehdot(t1);
      A.vastaaKysymykseen(t1);
    },
    $signature: 1
  };
  A.vastaaKysymykseen_closure.prototype = {
    call$1(e) {
      var t2, t3, _this = this,
        vastaus = type$.Element._as(A._convertNativeToDart_EventTarget(type$.MouseEvent._as(e).target)).textContent,
        t1 = _this._box_0;
      if (t1.vastattu)
        A.kaynnista(_this.kysymyslista);
      else {
        t2 = _this.elementti;
        t3 = J.getInterceptor$x(t2);
        if (vastaus == _this.oikein) {
          t3.set$text(t2, "Oikein");
          t1.vastattu = true;
          t1 = $.indeksi + 1;
          $.indeksi = t1;
          t2 = _this.kysymyslista;
          if (t1 === t2.length)
            A.lopeta(t2);
        } else {
          t3.set$text(t2, "V\xe4\xe4rin");
          t1.vastattu = true;
          t1 = $.indeksi + 1;
          $.indeksi = t1;
          t2 = _this.kysymyslista;
  ...
  A.lopeta_closure.prototype = {
    call$1(e) {
      var t1, t2;
      type$.MouseEvent._as(e);
      t1 = this.nappi.style;
      t1.display = "none";
      t1 = this.nappiAlusta.style;
      t1.display = "inline-block";
      t1 = document;
      t2 = t1.querySelector("#vastaus");
      t2.toString;
      J.get$children$x(t2).clear$0(0);
      t1 = t1.querySelector("#kysymys");
      t1.toString;
      J.set$text$x(t1, "Kaikkiin kysymyksiin vastattu!");
    },
    $signature: 1
  };
  A.lopeta_closure0.prototype = {
    call$1(e) {
      var t1, kysymyslista;
      type$.MouseEvent._as(e);
      $.indeksi = 0;
      ...
      t1 = this.nappiAlusta.style;
      t1.display = "none";
      kysymyslista = A.lisaaKysymyksia();
      this._box_0.kysymyslista = kysymyslista;
      A.kaynnista(kysymyslista);
    },
    $signature: 1
  };
  (function aliases() {
